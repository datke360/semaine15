...
class Joueur < Personne
  ...
  def degats
    ...
    # - Calculer les dégats
    # - Affiche ce qu'il s'est passé
    puts "#{@nom} bénéficie de #{@degats_bonus} points de dégats bonus"
    @degats_bonus + 15
  end
  ...
  def soin
    ...
    # - Affiche ce qu'il s'est passé
    @points_de_vie += 30
    puts "#{@nom} regagne 30 points de vie !"
  end
  ...
  def ameliorer_degats
    ...
    # - Affiche ce qu'il s'est passé
    @degats_bonus += 20
    puts "#{@nom} gagne 20 points de puissance !"
  end
end
...
if joueur.en_vie && monde.ennemis_en_vie.size == 0
  puts "Vous avez remporter ce combat !"
else
  puts "Vous avez perdu ce combat !"
end
